...
*   Steps that can be taken to improve performance/scalability:
    ...
    *   Add server software
        ...
        *   [Varnish](https://www.varnish-cache.org/)
            ...
            *   Checout cookie buster script for allowing of anonomous form submissions at http://lb.cm/cache\_buster
