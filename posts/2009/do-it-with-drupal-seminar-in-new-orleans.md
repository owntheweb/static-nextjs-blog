...
*   [Update status](https://drupal.org/project/update_status) module: Good for disconnected intranets that need the update features of connected Drupal websites (and other uses)
